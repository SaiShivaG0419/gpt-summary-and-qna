    ...
    "properties": {
        ...
        "Experience_Details": {
            ...
            "properties": {
                ...
                "Technical_Skills": {
                    "type": "array",
                    "description": "A list of aggregated technical skills mentioned in their resume under technical skills or technical summary or core competencies",
                    "items": {"type": "string"},
                },
            },
            "required": ["Overall_years_of_experience", "Technical_Skills"],
        },
        "Work_Experiences": {
            "type": "array",
            "items": {
                ...
                "properties": {
                    ...
                    "Start_time": {"type": "string", "description": "Month, YYYY"},
                    "End_time": {
                        "type": "string",
                    ...
                    "Experience_in_years": {
                        "type": "integer",
                        "description": "Years of experience in this organization as an integer. Calculate End time - Start time.",
                    },
